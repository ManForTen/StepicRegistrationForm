...
public class MainForm extends JFrame {
    ...
    public MainForm() {
        ...
        button.addActionListener(e -> {
            ...
            if (passwordField1.getPassword().length < 8||passwordField2.getPassword().length < 8||!Arrays.equals(passwordField1.getPassword(), passwordField2.getPassword())) { // Проверка паролей
